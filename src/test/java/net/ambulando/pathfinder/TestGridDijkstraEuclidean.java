...
@Getter
public class TestGridDijkstraEuclidean implements TestConfiguration {
  ...
  public TestGridDijkstraEuclidean() {
    cases.add(TestCase.builder().start(nodes.getNode(0, 0)).end(nodes.getNode(3, 5)).expectedPath("[(0,0)(0,1)(0,2)(1,3)(2,4)(3,5)]").build());
    cases.add(TestCase.builder().start(nodes.getNode(0, 0)).end(nodes.getNode(4, 5)).expectedPath("[(0,0)(0,1)(1,2)(2,3)(3,4)(4,5)]").build());
